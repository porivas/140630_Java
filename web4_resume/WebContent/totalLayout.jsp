...
<body>
		...
		<table class="ex1" border="1" >
			<tr align = "left">
				<thead>
				<th scope="col"><a href="resume.jsp"  target="story2">이력서</a></th>
				<th scope="col"><a href="coverletter.jsp"  target="story2">자기소개서</a></th>
				</thead>
			</tr>
		</table>
		</div>
		<div class ="me" id="story1">
				<iframe name="story2" width=100% height=100%>
